            ...
            try:
                ...
                if is_clarification or clarification_type:
                    ...
                    if clarification_type == "google_blocked" or clarification_type == "zomato_blocked" or clarification_type == "alternative":
                        ...
                        if alternative in ["zomato", "swiggy"]:
                            ...
                            await websocket.send_json({
                                "type": "status",
                                "message": f"Switching to {alternative.capitalize()}..."
                            })
                    ...
                    # Check if this is a site selection (for local discovery)
                    response_lower = instruction.lower().strip()
                    if response_lower in ["zomato", "swiggy", "google"] or clarification_type == "site_selection" or clarification_type == "local_discovery":
                        ...
                        await websocket.send_json({
                            "type": "status",
                            "message": f"Using {response_lower.capitalize()} for local discovery..."
                        })
